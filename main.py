...
def get_resp(url, headers, expandCol, cols, expandColSelect=None, expandColFilter=None, pagination=None, addpars={}):
    ...
    expandString = None
    if expandColSelect:
        expandString = expandCol + (f"($select={','.join(expandColSelect)}{f';$filter={expandColFilter}' if expandColFilter else ''})")
...
def main(tableSelection=1):
    ...
    tbls = [
        ...
        {'name': 'wmsPostedDocumentHeaders', 'func': Tables.wmsPostedDocumentHeaders, 'urlDir': 'boltrics/boltrics/v1.0', 'endpoint': 'wmsPostedDocumentHeaders', 'merge': False, 'mergeKeys': ['id'], 'filter': False, 'filterField': 'modifiedDateTime', 'cols': ['id', "documentType", "no", "sellToCustomerNo", "sellToCustomerName", "billToCustomerName", "buildingCode", "salespersonCode", "direction", "documentDate", "postingDate", "statusCode", "deliveryDate", "customsCode", "sendersAddressName", "shipToAddressName", "shortcutDimension2Code", "attribute04", "attribute05", 'modifiedDateTime'], 'expandCol': None, 'expandColSelect': [], 'pars': None},
    ...
    tbls_live = [
        ...
        #Klaar fact
        {'name': 'wmsDocumentLines', 'func': Tables.wmsDocumentLines, 'urlDir': 'boltrics/boltrics/v1.0', 'endpoint': 'wmsDocumentLines', 'merge': False, 'mergeKeys': ['id'], 'filter': False, 'filterField': 'modifiedDateTime', 'cols': ["id", "documentType", "documentNo", "lineNo", "sellToCustomerNo", "sellToCustomerNo2", "buyFromVendorNo", "dossierNo", "carrierTypeCode", "currencyCode", "currencyFactor", "lineAmountLCY", "type", "no", "externalNo", "itemNo", "description", "description2", "baseUnitOfMeasureCode", "unitOfMeasureCode", "qtyPerUnitOfMeasure", "quantity", "quantityBase", "qtyOutstanding", "qtyBaseOutstanding", "storageChargeNo", "unitPrice", "lineAmount", "carrierQuantity", "qtyPerCarrier", "carrierQtyOutstanding", "createdDateTime", "createdUserID", "modifiedDateTime", "modifiedUserID", "orderUnitOfMeasureCode", "qtyPerOrderUnitOfMeasure", "tareWeightPerUoM", "grossWeightPerUoM", "netWeightPerUoM", "volumeWeight", "tareWeight", "grossWeight", "netWeight", "batchNo", "externalBatchNo", "grossWeightOutstanding", "netWeightOutstanding", "qtyToHandle", "customerItemNo2", "batchNo2", "storageChargeNo2", "unitOfMeasureCode2", "locationNo", "buildingCode", "customsCode", "tariffNo", "countryOfOriginCode", "countryPurchasedCode", "customsValue", "customsValuePer", "ncTsDocumentNo", "additionalDocumentNo", "placeOfCertificateDelivery", "destination", "declarationDocumentType", "customsCurrencyCode", "containerNo", "vesselNo", "itemHandling", "orderTypeCode", "entrepotStorage", "commentText", "externalDocumentNo", "shortcutDimension1Code", "shortcutDimension2Code", "postingDate", "invoiceType", "invoiceNo", "invoiceDate", "purchInvoiceNo", "purchInvoiceDate", "reservationPosted", "agreementType", "agreementNo", "agreementLineNo", "agreementDetailLineNo", "agreementDetailLineType", "senderAddressNo", "isActivity", "shiptoAddressNo", "activityDate", "activityTime", "customsIssueDate", "declarationDocumentNo", "attribute01", "attribute02", "attribute03", "attribute04", "attribute05", "sellToCustomerName", "buyFromVendorName", "qtyCreated", "qtyPosted", "qtyBaseCreated", "qtyBasePosted", "carrierQtyCreated", "carrierQtyPosted", "defaultNetWeightPerUOM", "grossWeightCreated", "netWeightCreated", "grossWeightPosted", "netWeightPosted", "tariffDescription", "shiptoAddressName"], 'expandCol': None, 'expandColSelect': [], 'pars': None},
        {'name': 'wmsDocumentHeaders', 'func': Tables.wmsDocumentHeaders, 'urlDir': 'boltrics/boltrics/v1.0', 'endpoint': 'wmsDocumentHeaders', 'merge': False, 'mergeKeys': ['id'], 'filter': False, 'filterField': 'modifiedDateTime', 'cols': ['id', 'documentType', 'no', 'sellToCustomerNo', 'buildingCode', 'postingDate', 'statusCode', 'containerNo', 'vesselNo', 'orderTypeCode', 'senderAddressNo', 'shipToAddressNo', 'billOfLadingNo', 'shortcutDimension2Code', 'attribute04', 'containerSizeCode', 'sellToCustomerName', 'billToCustomerNo', 'billToCustomerName', 'salespersonCode', 'direction', 'locationNo', 'movementType', 'documentDate', 'orderDate', 'statusTemplateCode', 'createdDateTime', 'modifiedDateTime', 'noSeries', 'externalDocumentNo', 'externalReference', 'shippingAgentCode', 'announcedDate', 'announcedTime', 'arrivedDate', 'arrivedTime', 'departedDate', 'deliveryDate', 'estimatedDepartureDate', 'parentDocumentType', 'parentDocumentNo', 'customsCode', 'tariffNo', 'countryOfOriginCode', 'countryOfDestinationCode', 'declarationDate', 'destination', 'expectQtyCarriers', 'customsValue', 'incotermsCode', 'invoiceValue', 'incotermsCity', 'additionalDocumentNo', 'certificateNo', 'shortcutDimension1Code', 'attribute05', 'grossWeight', 'netWeight', 'quantity', 'carrierQuantity', 'portFrom', 'portTo', 'sealNo', 'sendersAddressName', 'shipToAddressName', 'sendersAddressCity', 'shipToAddressCity', 'carrierQtyCreated', 'consigneeName', 'shipperName', 'agentName', 'plannedEndDate', 'attribute07', 'sortingOrder'], 'expandCol': 'wmsDocInfoSetEntries', 'expandColSelect': ['informationCode', 'textValue'], 'expandColFilter': "(informationCode eq '06PDIUS')", 'pars': None},
        {'name': 'wmsCarrierContent', 'func': Tables.wmsCarrierContent, 'urlDir': 'boltrics/boltrics/v1.0', 'endpoint': 'wmsCarrierContent', 'merge': False, 'mergeKeys': ['id'], 'filter': False, 'filterField': None, 'cols': ['id', 'modifiedDateTime', "locationNo", "carrierNo", "customerItemNo", "batchNo", "locationPath", "netWeight", "buildingCode", "length", "width", "height","unitOfMeasureCode","quantity", "carrierTypeCode", "receiptDate", "statusCode", "locationTypeCode", "zoneCode", "zoneType", "custItemDescription", "externalCustomerItemNo", "attribute01"], 'expandCol': None, 'expandColSelect': [], 'pars': None},
    ...
    for customer in customers:
        ...
        for t in tbls:
            ...
            resp = get_resp(url, headers=headers, pagination=False if testing else True, addpars=pars, cols=t['cols'], expandCol=t['expandCol'], expandColSelect=t['expandColSelect'], expandColFilter=t.get('expandColFilter', None))
